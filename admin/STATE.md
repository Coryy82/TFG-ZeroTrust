...
## 1. Resumen Semanal
- Commits últimos 7 días: **14 entradas** (05/06–12/06). Infra ZT+Wazuh cerrada; KPI A↔B cerrada (09/06); redacción memoria acelerada (10–12/06: Caps. 4 y 6, EdA §2.7).
...
- Pendiente redacción inmediata: **Cap. 3** (`03_analisis_problema.md` — deuda 11/06); **Cap. 5** (`05_desarrollo_implantacion.md` §5.1–5.4 — prioridad 12/06); §4.5 cierre; §1.2 Introducción (pregunta de investigación).
- Días hasta próximo hito crítico: **2 días** hasta el 14/06 (Caps. 3–6 en borrador + email tutor 60–70%).
...
- Delta respecto al plan: la línea técnica va **adelantada** (Fase 2 cerrada 04/06; KPIs 09/06). Redacción va **con retraso acumulado**: Cap. 6 cerrado (12/06, 2 días tarde vs agenda); **Cap. 3 y Cap. 5 sin empezar** con 2 días al hito 14/06.
- Riesgos activos con nivel (ALTO/MEDIO/BAJO):
  - **ALTO:** hito 14/06 en 2 días con Cap. 3 y Cap. 5 enteros pendientes; volumen de redacción concentrado en 12–13/06.
...
- **Bloqueo potencial:** cadencia de redacción — Cap. 3 y Cap. 5 sin borrador con 2 días al hito 14/06. Mitigación: priorizar Cap. 5 §5.3 (Escenario B) y Cap. 3 §3.1–3.4 el 12/06; buffer repaso 13/06.
...
### DOING
- [ ] **[HUMANO] `redactar_cap_3_4_5`** — Caps. 3–6 en borrador (09–13/06). **Avance 12/06:** Cap. 4 §4.1–4.3 + tabla §4.4; Cap. 6 §6.1–6.4 completo. Pendiente: Cap. 3 (§3.1–3.4), Cap. 5 (§5.1–5.4), §4.5 cierre, figuras `[FIG:]` Cap. 6.
...
| 14/06  | Caps. 3, 4, 5, 6 en borrador + email tutor                | ⚠️ En riesgo alto — Cap. 6 ✅; Cap. 3 y Cap. 5 pendientes; 2 días restantes |
